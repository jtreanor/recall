...
- [ ] Add a short animated GIF showing the overlay in action — capture plan, storyboard, and exact commands in `docs/demo-gif.md`; README has a commented-out placeholder; recording is manual
...
**Version:** 1.1.0-dev (Phase 8 README rewrite done; demo GIF recording pending — see `docs/demo-gif.md`)  
**Next:** record the demo GIF, then cut 1.1.0
